...
export default function Projects() {
  const projects: Project[] = [
    ...
    },
    {
      ...
      title: "Atlas Africa",
      description:
        "Our flagship platform—a digital investment matchmaking ecosystem connecting African founders with capital, coaching, and collaboration. This smart investment platform reimagines how early-stage founders access funding and support.",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300">
            Explore some of the initiatives I've led to drive positive change across
            Africa.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <motion.div
              key={project.id}
              className="bg-gray-200 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-all hover:shadow-lg group"
              ...
              <div className="p-6">
                ...
                {project.link && project.link.trim() !== "" ? (
                  <a
                    ...
                    className="text-blue-600 dark:text-blue-400 font-medium flex items-center hover:underline transition-all"
                  >
                    Learn More
                    <svg
                  ...
                  <span className="text-gray-400 dark:text-gray-600 font-medium flex items-center cursor-not-allowed">
                    Learn More
                    <svg
                      className="h-5 w-5 ml-1"
                      fill="none"
        ...
        <div className="text-center mt-12">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <ul className="space-y-4 text-left">
              <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded-lg shadow">
                <h4 className="font-bold text-lg">
                  Smart Local AI Assistant{" "}
                  <span className="text-orange-500 text-sm">(WIP)</span>
                </h4>
                <p className="text-gray-700 dark:text-gray-300">
                  A locally hosted AI-powered application with multi-modal capabilities,
                  allowing users to process text, documents, images, voice, and video using
                  custom LLMs. Built with PySide6 for a responsive, modern UI with animations.
                </p>
              </li>
              <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded-lg shadow">
                <h4 className="font-bold text-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  An interactive dashboard visualizing the distribution and impact of
                  innovation hubs across the continent. Built using publicly available
                  datasets, with Google Data Studio and Python.
                </p>
              </li>
            </ul>
          </div>
